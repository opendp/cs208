...
\item The dataset \texttt{MaPUMS5full.csv} provides the 5\% PUMS Census file for Massachusetts. For $\varepsilon=1$
and each $B \in \{5\times 10^5, 5\times 10^6, 5\times 10^7\}$, estimate the RMSE of DP mean income for
each PUMA in Massachusetts.\footnote{You can assume that the size
